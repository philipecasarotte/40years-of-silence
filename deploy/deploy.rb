...
# =============================================================================
set :user, "yeeie"
set :password, "725lemyng"
set :host, "40yearsofsilence.com"
set :domain, "40yearsofsilence.com"
set :application, "40yearsofsilence"

set :repository, "git://dburnsdesign.com/40years/mainline.git"
...
namespace :deploy do
  ...
  task :symlink do
    on_rollback {}
    run <<-CMD
      rm -rf #{current_path}/log #{current_path}/public/uploads #{current_path}/tmp/pids #{current_path}/config/database.yml &&
